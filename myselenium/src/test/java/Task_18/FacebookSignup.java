...
public class FacebookSignup {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Santu");
		Thread.sleep(1000);
		//Entering the last name
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Sonar");
		Thread.sleep(2000);
		//Entering the email address
		driver.findElement(By.name("reg_email__")).sendKeys("testuser2@test.com");
		Thread.sleep(2000);
		...
		driver.findElement(By.cssSelector("input[id='sex'][value='2']")).click();
		Thread.sleep(2000);
